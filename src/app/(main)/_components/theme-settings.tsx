...
// ponytail: landing-page copy of dashboard layout-controls with layout/sidebar sections removed (template untouched)
      ...
      <PopoverContent align="end">
        <div className="flex flex-col gap-5">
          <div className="space-y-1.5">
            ...
            <p className="text-muted-foreground text-xs">Customize the site theme and typography.</p>
          </div>
